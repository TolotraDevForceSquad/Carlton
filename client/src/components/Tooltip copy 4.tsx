...
const Tooltip = ({ children, frLabel, enLabel = '', onSave }: TooltipProps) => {
  ...
  const handleMouseDown = (e: React.MouseEvent) => {
    ...
    showTimeoutRef.current = setTimeout(() => {
      document.dispatchEvent(new CustomEvent('hideAllTooltips'));
      setPosition(pos);
      setShowTooltip(true);
    }, LONG_PRESS_DELAY);
  };
  ...
  useEffect(() => {
    ...
    document.addEventListener('hideAllTooltips', handleHideAll);
    document.addEventListener('contextmenu', handleGlobalContextMenu, true);

    return () => {
      document.removeEventListener('hideAllTooltips', handleHideAll);
