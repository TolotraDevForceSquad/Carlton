...
export const homeData = {
  ...
  content: {
    ...
    en: "<p>The Carlton Madagascar is more than a 5-star hotel. It is an invitation to travel, a unique experience in the heart of Antananarivo where French elegance meets Malagasy authenticity to create unforgettable memories.</p>"
  },
  highlights: [
    {
      icon: "Sparkles",
      ...
      link: "/chambres",
      image: "http://localhost:5000/uploads/Presidential_suite_bedroom_interior_7adece21.png"
    },
    {
      icon: "Utensils",
      title: {
  ...
  cta: {
    ...
    description: {
      ...
      en: "Discover Malagasy hospitality in the luxurious setting of Carlton Madagascar"
    },
    primaryButton: {
